...
export default function PracticeSetsPage() {
  // Show a couple of upcoming slots so the roadmap is visible even though only
  // Set 1 exists for now.
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Practice Sets</h1>
        <p className="mt-2 max-w-2xl text-slate-400">
          Full-length SAA-C03 practice sets. Work through each question at your own
          pace and see the correct answer and explanation immediately after you
          submit.
        </p>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {practiceSets.map((set) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-amber-400/40 hover:shadow-2xl hover:shadow-amber-500/10"
            >
          ...
          {locked.map((n) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-500">
                A new full-length SAA-C03 set is on the way.
              </p>
